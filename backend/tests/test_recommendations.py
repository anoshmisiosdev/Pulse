...
def test_a_single_visit_customer_is_only_watched():
    """One visit means the score is barely evidence — don't spend an offer on it."""
    action, reason = recommend_action(_scored(visits=1), 100.0)
    assert action == "watch"
