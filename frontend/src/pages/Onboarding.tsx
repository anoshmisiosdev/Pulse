    ...
    <div className="mx-auto max-w-3xl">
      <div className="anim-fade-up text-center">
        ...
        <p className="mx-auto mt-2 max-w-xl italic" style={{ color: "var(--muted)", fontSize: "15.5px" }}>
          Churnary watches your payment system and flags customers who are about to slip away. Pick where your customers live.
        </p>
      </div>
      ...
      <div className="glass anim-fade-up mt-4 p-7" style={{ animationDelay: "0.1s" }}>
        ...
        <div className="mt-5">
          {source === "csv" ? (
            <Field label="Customer CSV" hint="Columns: name, email, last visit, spend. Missing fields are fine — Churnary redistributes the weight.">
